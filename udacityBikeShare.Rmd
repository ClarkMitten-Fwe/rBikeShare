...
library(data.table)
library(lubridate)
#tic toc pacage times processes. I use this to test my code and decide if I want to look for a more efficient alternative
library(tictoc)
...
ggplot(data) +
  ...
  scale_x_discrete() +
  ggtitle('Mean Travel Time by Month') +
  labs(x = 'Travel Time in Minutes', y = 'Count of Trips')
